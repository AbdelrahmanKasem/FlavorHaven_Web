...
namespace RMSProjectAPI.Migrations
{
    ...
    [Migration("20250428093100_AddingCashierRole")]
    partial class AddingCashierRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RMSProjectAPI.Database.Entity.OrderItemExtra", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RMSProjectAPI.Database.Entity.Order", b =>
                {
                    b.HasOne("RMSProjectAPI.Database.Entity.User", "CashierPerson")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("RMSProjectAPI.Database.Entity.OrderItemExtra", b =>
                {
                    b.HasOne("RMSProjectAPI.Database.Entity.Extra", "Extra")
                        .WithMany()
